---
page_title: "aaa-v1 Provider"
---

# aaa-v1 Provider

This provider is used to interact with the resources provided by the **aaa-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
