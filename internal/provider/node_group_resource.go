...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/resource_node_group"
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/tfutils"
)

const (
	create_rs_nodeGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/nodegroups"
	read_rs_nodeGroup   = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/nodegroups/{name}"
	update_rs_nodeGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/nodegroups/{name}"
	delete_rs_nodeGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/nodegroups/{name}"
)

var (
	_ resource.Resource                = (*nodeGroupResource)(nil)
	_ resource.ResourceWithConfigure   = (*nodeGroupResource)(nil)
	_ resource.ResourceWithImportState = (*nodeGroupResource)(nil)
)
...
func (r *nodeGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_nodeGroup, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_nodeGroup, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_nodeGroup,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *nodeGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_nodeGroup, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *nodeGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_nodeGroup, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
