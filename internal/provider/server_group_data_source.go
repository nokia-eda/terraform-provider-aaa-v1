...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/datasource_server_group"
...
const read_ds_serverGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/servergroups/{name}"

var (
	_ datasource.DataSource              = (*serverGroupDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*serverGroupDataSource)(nil)
)
...
func (d *serverGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_server_group.ServerGroupDataSourceSchema(ctx)
}

func (d *serverGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_server_group.ServerGroupModel
	...
	err = d.client.GetByQuery(ctx, read_ds_serverGroup, map[string]string{
...
func (r *serverGroupDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
