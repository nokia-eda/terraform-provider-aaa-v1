...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/datasource_node_group"
...
const read_ds_nodeGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/nodegroups/{name}"

var (
	_ datasource.DataSource              = (*nodeGroupDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*nodeGroupDataSource)(nil)
)
...
func (d *nodeGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_node_group.NodeGroupDataSourceSchema(ctx)
}

func (d *nodeGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_node_group.NodeGroupModel
	...
	err = d.client.GetByQuery(ctx, read_ds_nodeGroup, map[string]string{
...
func (r *nodeGroupDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
