...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/resource_server_group"
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/tfutils"
)

const (
	create_rs_serverGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/servergroups"
	read_rs_serverGroup   = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/servergroups/{name}"
	update_rs_serverGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/servergroups/{name}"
	delete_rs_serverGroup = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/servergroups/{name}"
)
...
func (r *serverGroupResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_server_group.ServerGroupResourceSchema(ctx)
}

func (r *serverGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_server_group.ServerGroupModel
	...
	err = r.client.Create(ctx, create_rs_serverGroup, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_serverGroup, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_serverGroup,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *serverGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_serverGroup, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *serverGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_serverGroup, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
