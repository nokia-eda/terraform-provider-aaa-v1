...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/resource_authentication_policy"
	"github.com/nokia/eda/apps/terraform-provider-aaa/internal/tfutils"
)

const (
	create_rs_authenticationPolicy = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/authenticationpolicies"
	read_rs_authenticationPolicy   = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/authenticationpolicies/{name}"
	update_rs_authenticationPolicy = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/authenticationpolicies/{name}"
	delete_rs_authenticationPolicy = "/apps/aaa.eda.nokia.com/v1/namespaces/{namespace}/authenticationpolicies/{name}"
)

var (
	_ resource.Resource                = (*authenticationPolicyResource)(nil)
	_ resource.ResourceWithConfigure   = (*authenticationPolicyResource)(nil)
	_ resource.ResourceWithImportState = (*authenticationPolicyResource)(nil)
)
...
func (r *authenticationPolicyResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_authentication_policy.AuthenticationPolicyResourceSchema(ctx)
}

func (r *authenticationPolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_authentication_policy.AuthenticationPolicyModel
	...
	tflog.Info(ctx, "Create()::API request", map[string]any{
		"path": create_rs_authenticationPolicy,
	...
	err = r.client.Create(ctx, create_rs_authenticationPolicy, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_authenticationPolicy, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_authenticationPolicy,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *authenticationPolicyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_authenticationPolicy,
		"body": spew.Sdump(reqBody),
	})
	...
	err = r.client.Update(ctx, update_rs_authenticationPolicy, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *authenticationPolicyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_authenticationPolicy,
		"data": spew.Sdump(data),
	})
	...
	err := r.client.Delete(ctx, delete_rs_authenticationPolicy, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *authenticationPolicyResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
