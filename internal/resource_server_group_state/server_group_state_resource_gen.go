...
package resource_server_group_state
...
func ServerGroupStateResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ServerGroupState$"), ""),
				},
				Default: stringdefault.StaticString("ServerGroupState"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ServerGroupState",
				MarkdownDescription: "name of the ServerGroupState",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"aaa_servers": schema.ListAttribute{
						ElementType: types.StringType,
						Optional:    true,
					},
				...
				Required:            true,
				Description:         "ServerGroupStateSpec defines the desired state of ServerGroupState",
				MarkdownDescription: "ServerGroupStateSpec defines the desired state of ServerGroupState",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "ServerGroupStateStatus defines the observed state of ServerGroupState",
				MarkdownDescription: "ServerGroupStateStatus defines the observed state of ServerGroupState",
			},
		},
	}
}

type ServerGroupStateModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	serverTypeAttribute, ok := attributes["server_type"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`server_type is missing from object`)

		return nil, diags
	}

	serverTypeVal, ok := serverTypeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`server_type expected to be basetypes.StringValue, was: %T`, serverTypeAttribute))
	}
...
type SpecValue struct {
	...
	ServerType basetypes.StringValue `tfsdk:"server_type"`
	state      attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["server_type"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ServerType.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["server_type"] = val
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var aaaServersVal basetypes.ListValue
	switch {
	case v.AaaServers.IsUnknown():
		aaaServersVal = types.ListUnknown(types.StringType)
	case v.AaaServers.IsNull():
		aaaServersVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		aaaServersVal, d = types.ListValue(types.StringType, v.AaaServers.Elements())
		diags.Append(d...)
	}
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"server_type": basetypes.StringType{},
		}), diags
	}
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.ServerType.Equal(other.ServerType) {
		return false
	}
