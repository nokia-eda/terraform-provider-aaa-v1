...
package datasource_server_group_state_list
...
func ServerGroupStateListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ServerGroupStateListModel struct {
