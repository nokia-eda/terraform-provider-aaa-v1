...
package datasource_authentication_policy_state_list
...
func AuthenticationPolicyStateListDataSourceSchema(ctx context.Context) schema.Schema {
...
type AuthenticationPolicyStateListModel struct {
