...
func NodeGroupResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^NodeGroup$"), ""),
				},
				Default: stringdefault.StaticString("NodeGroup"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the NodeGroup",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
